...
%default values
default_scim_ver = '5';
default_data_dir = 'F:\GRABiCorre\893-02162021';
%default_scim_ver = '5';
...
default_grid_roi = '0';  
%ask user
prompt = {'ScanImage verison (3 or 5):','Root directory (for saving):','Subdirectory with registered .tiff images (to be analyzed):','Grid ROIs?'};
dlg_title = 'Load ROIs and extract signals from registered images';
num_lines = 1;
defaultans = {default_scim_ver,default_data_dir,default_reg_subdir, default_grid_roi};
...
for j=1:numel(stacks)
    ...
    cd(fullfile(data_dir,reg_subdir));
